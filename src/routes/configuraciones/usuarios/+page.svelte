<script lang="ts">
    ...
    import {
        ...
        Search, Users, Shield, X, SlidersHorizontal
    } from '@lucide/svelte';
...
<div class="px-4 md:px-8 py-8 max-w-7xl space-y-5">
    ...
    <div class="flex items-start justify-between gap-4 flex-wrap">
        <div>
            <div class="flex items-center gap-2.5 mb-2">
                ...
                <h2 class="text-lg font-semibold text-neutral-100">Usuarios del Sistema</h2>
            </div>
            <p class="text-sm text-neutral-500">Administra las cuentas de los empleados, sus roles y permisos de acceso.</p>
        </div>
        <div class="flex items-center gap-2">
            {#if auth.isSuperAdmin}
                <a href="/configuraciones/seguridad"
                    class="flex items-center gap-2 px-3 py-2 rounded-lg border border-neutral-700 hover:border-primary-500/50 text-neutral-300 hover:bg-primary-500/5 text-sm font-medium transition-colors">
                    <Shield class="size-4" /> Roles y permisos
                </a>
            {/if}
    ...
    <div class="bg-card border border-neutral-800 rounded-xl p-4 space-y-3">
        ...
        {#if filtersOpen}
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3 pt-2 border-t border-neutral-800" transition:fade={{ duration: 120 }}>
                <!-- Status -->
                <div>
                    <label for="filt-status" class="block text-xs text-neutral-400 mb-1">Estado</label>
                    <select
                        id="filt-status"
                ...
                <!-- Role -->
                <div>
                    <label for="filt-role" class="block text-xs text-neutral-400 mb-1">Rol</label>
                    <select
                        id="filt-role"
                ...
                <!-- Date from -->
                <div>
                    <label for="filt-date-from" class="block text-xs text-neutral-400 mb-1">Desde</label>
                    <input type="date"
                        id="filt-date-from"
                ...
                <!-- Date to -->
                <div>
                    <label for="filt-date-to" class="block text-xs text-neutral-400 mb-1">Hasta</label>
                    <input type="date"
                        id="filt-date-to"
                ...
                <!-- Trashed -->
                <div>
                    <label for="filt-trashed" class="block text-xs text-neutral-400 mb-1">Eliminados</label>
                    <select
                        id="filt-trashed"
                ...
                <!-- Per page -->
                <div>
                    <label for="filt-per-page" class="block text-xs text-neutral-400 mb-1">Por página</label>
                    <select
                        id="filt-per-page"
