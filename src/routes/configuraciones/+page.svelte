<script lang="ts">
  ...
  const cards: ConfigCard[] = [
    ...
    },
    {
      ...
      badgeColor: 'blue',
      status: 'available',
      features: ['Gestión de roles', 'Permisos por módulo', 'Mapa de permisos', 'Asignación granular'],
    },
    {
      id: 'usuarios',
      ...
      badgeColor: 'blue',
      status: 'available',
      features: ['Alta de empleados', 'Asignación de roles', 'Búsqueda y filtros', 'Deshabilitar cuentas'],
    },
    {
      id: 'notificaciones',
