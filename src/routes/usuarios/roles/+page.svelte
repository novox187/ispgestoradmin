<script lang="ts">
    ...
    import {
        ArrowLeftIcon, PlusIcon, Pencil, Trash2, Shield, Users, Lock, Key, Info
    } from '@lucide/svelte';
    ...
    <div class="p-4 md:p-6 max-w-7xl mx-auto w-full space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                <a href="/usuarios" class="p-2 rounded-lg hover:bg-neutral-800 transition-colors text-neutral-400 hover:text-white">
                    <ArrowLeftIcon class="size-5" />
                </a>
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold">Roles y Permisos</h1>
                    <p class="text-sm text-gray-400 mt-1">Gestiona el control de acceso del sistema</p>
                </div>
            </div>
